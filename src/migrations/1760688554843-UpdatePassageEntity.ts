...
export class UpdatePassageEntity1760688554843 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "passages" DROP CONSTRAINT IF EXISTS "passages_part_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "passages" DROP CONSTRAINT IF EXISTS "FK_48fb350b4a2fb51bd954002ea7c"`);
        await queryRunner.query(`ALTER TABLE "passages" DROP CONSTRAINT IF EXISTS "FK_9293dff639e96b9ad7773798b4e"`);
        await queryRunner.query(`ALTER TABLE "questions" DROP CONSTRAINT IF EXISTS "FK_71de478c6bb3635a98680f68037"`);
        ...
        await queryRunner.query(`
            ...
            ADD CONSTRAINT "FK_9293dff639e96b9ad7773798b4e" 
            FOREIGN KEY ("test_id") REFERENCES "toeic_tests"("id") ON DELETE CASCADE
            `);

        await queryRunner.query(`
            ALTER TABLE "passages" 
            ADD CONSTRAINT "FK_48fb350b4a2fb51bd954002ea7c" 
            FOREIGN KEY ("part_id") REFERENCES "toeic_parts"("id") ON DELETE CASCADE
            `);

        await queryRunner.query(`
            ALTER TABLE "questions" 
            ADD CONSTRAINT "FK_71de478c6bb3635a98680f68037" 
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "passages" DROP COLUMN IF EXISTS "title"`);
        await queryRunner.query(`ALTER TABLE "passages" ADD "title" character varying(255)`);
        await queryRunner.query(`ALTER TABLE "passages" DROP COLUMN IF EXISTS "test_id"`);
        await queryRunner.query(`ALTER TABLE "passages" DROP COLUMN IF EXISTS "passage_number"`);
